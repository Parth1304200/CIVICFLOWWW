      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 sm:inset-auto sm:bottom-24 sm:right-6 w-full h-full sm:w-[350px] sm:h-[500px] bg-white sm:rounded-2xl shadow-2xl border-0 sm:border border-slate-200 flex flex-col z-50 overflow-hidden"
          >
            {/* Header */}
            <div className="bg-slate-900 px-4 py-3 flex items-center justify-between text-white shadow-md">
              <div className="flex items-center gap-3">
                <button
                  onClick={() => setIsOpen(false)}
                  className="sm:hidden text-slate-300 hover:text-white transition-colors p-1 -ml-2"
                >
            ...
            {/* Warning Banner */}
            <div className="bg-amber-50 px-4 py-2 flex items-start gap-2 border-b border-amber-100 shadow-sm">
